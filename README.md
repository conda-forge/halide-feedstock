...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/halide-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/halide-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2998&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/halide-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add halide halide-python
# for installing globally
pixi global install halide halide-python
```
...
It is possible to list all of the versions of `halide` available on your platform:
...
```
pixi search halide --channel conda-forge
```
